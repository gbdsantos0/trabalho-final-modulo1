              ...
              <table role="presentation" style="width:100%;border-collapse:collapse;border:0;border-spacing:0;">
                <tr>
                  <td style="padding:0 0 36px 0;color:#153643;">
                    ...
                    <p style="margin:0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;"><a href="localhost:8080/${key}" style="color:#ee4c50;text-decoration:underline;">click here</a></p>
                  </td>
                </tr>
                <tr>
                  <td style="padding:0;">
